...
+ ohniste : CustomImmovable 'otevřené ohniště' 'ohniště' *4
...
+ drevo : CustomImmovable 'voňavé dřevo' 'dřevo' *4
...
+ postele : Bed, CustomImmovable 'nízké postele' 'postele/lůžka' *3
...
+ lenosky : Bed, CustomImmovable 'jednoduché lenošky' 'lenošky' *3
...
+ kotlik : RestrictedContainer, CustomImmovable 'želený kotlík' 'kotlík' *2
...
++ jidloZKotliku : Food, CustomImmovable 'bizoní maso' 'maso/jídlo' *4
...
+ provazy : RestrictedContainer, CustomImmovable 'závěsné provazy' 'provazy' *2
...
++ deky : CustomImmovable 'kožené/látkové deky' 'deky' *3
...
++ castiOdevu : Wearable, CustomImmovable 'části oděvu' 'části' *3
...
+ truhla : Container, CustomImmovable 'bytelná truhla' 'truhla' *3
...
++ dolar : Thing 'jeden dolar' 'dolar' *2
...
++ kresadlo : PreferredIobj, Thing 'indiánské křesadlo' 'křesadlo' *4
...
++ polamaneSipy : Thing 'polámané šípy' 'šípy' *2
...
++ tomahawk : Thing 'malý tomahawk' 'tomahawk' *2
...
++ jehla : Thing 'špičatá jehla' 'jehla' *3
...
++ suseneMaso : Food 'sušené maso' 'maso' *4
...
++ mapa : Thing 'orientační mapa' 'mapa' *3
...
++ kosile : Wearable 'indiánská košile' 'košile' *3
    ...
    dobjFor(Wear)
    {
        action()
        {
			...
			Uznej, že dívky mají také právo užít si polonahého a pěkně ozdobeného muže, nekaz jim tu radost. ";
        }
    }
...
++ leginy : Wearable 'kožené legíny/legín' 'legíny' *2
...
++ kozesina : Wearable 'bizoní kožešina' 'kožešina' *3
...
++ kozenePouzdro : RestrictedContainer 'kožené pouzdro' 'pouzdro' *4
