 ...
 */
mistnostTipiValecnehoNacelnika : Room 'Týpí válečného náčelníka' 'týpí válečného náčelníka'
	...
	out: TravelMessage { -> mistnostPredTipimValecnehoNacelnika "Otvorem v týpí vycházíš ven. " }
	east asExit(out)
;
