...
inlineListingAttachmentsLister: ContentsLister
    ...
    /*
     *   Tady je dost zajámavé, že i když parent je správný objekt, parametr se
     *   může 
     */
    showListPrefixWide(cnt, pov, parent, selector)
    {
        ...
        " (ke kter<<buildParam('ému', nm)>> <<tSel(selector < 4 ? 'je' : 'jsou', ['byl',
            'byla', 'bylo', 'byli', 'byly', 'byla'][selector])>>
